...
def sorted_absolute(numbers: list):
...
#     x = sorted(quote.split())
#     print(x, key=return_len)
        # y = x.sorted()

    # x.sort()  # sorts normally by alphabetical order
...
#
# def return_len(quote):
#     list(map(str, filter(quote)))
#     print(quote)
#     sorted(shortest_to_longest, key=return_len)
