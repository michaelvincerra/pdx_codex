...
class TestAccountCreation(unittest.TestCase):
    def setUp(self):
        self.test_caccount = Account(first_name='first_name', surname='surname', _balance=270, account_type ='checking')
        self.test_saccount = Account(first_name='first_name', surname='surname', _balance=10454, account_type ='savings')
    ...
    def test_account_creation_from_csv_string(self):
        record = 'Bill,Smith,5902692944186857,151.5,checking'
...
class TestAccountOperations(TestAccountCreation):
    ...
    def test_get_balance(self):
        test_account = Account(first_name='first_name', surname='surname', _balance=500, account_type ='savings')
